...
if (isset($_GET['id']) && isset($_GET['name'])) {
    $_SESSION['friendId'] = $_GET['id'];
    $_SESSION['friendName'] = $_GET['name'];
}
...
<body>
    <div class="container">
        <h1>You Friend Picture</h1>
         
        <!-- Album Selection -->
        <select id="albumSelection" name="albumSelection">
            <option value="">Select an Album</option>
            <?php
            foreach (getFriendAlbum($_SESSION["friendId"]) as $option) :
